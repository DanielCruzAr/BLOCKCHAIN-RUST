...
use log::error;
use crate::{blockchain::Blockchain, errors::Result, tx::{TXInput, TXOutput}, wallet::{hash_pub_key, Wallets}};
...
impl Transaction {
    ...
    // TODO) Join sign & verify functionalities in a single function in utils
    pub fn sign(
        &mut self,
        private_key: &[u8],
